...
<div class="row">
    <div class="col">
        <div class="page-title-box">
            <h2 class="page-title font-weight-bold text-uppercase">Manage Company</h2>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card-box">
            <a href="{{route('add-company') }}" class="btn btn-sm btn-blue waves-effect waves-light float-right">
                <i class="mdi mdi-plus-circle"></i> Create New Company
            </a>
            <h4 class="header-title mb-4 text-uppercase">Manage Company</h4>
            <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled">
                                        ...
                                        <li><b>Phone:</b> <span>{{ $tableData->mobile_no }}</span></li>
                                    </ul>
                                </td>
                                <td>
                                    <ul class="list-unstyled">
                                        <li><b>State:</b> <span>{{ $tableData->state }}</span></li>
                                        <li><b>Country:</b> <span>{{ $tableData->country }}</span></li>
                                        <li><b>PAN No:</b> <span>{{ $tableData->pan_no }}</span></li>
                                        <li><b>Invoice No:</b> <span>{{ $tableData->invoice_no }}</span></li>
                                    </ul>
                                </td>
                                <td>
                                    <ul class="list-unstyled">
                                        <li><b>Company Name:</b> <span>{{$tableData->company_name}}</span></li>
                                        <li><b>Email:</b> <span>{{$tableData->email}}</span></li>
                                        <li><b>Website:</b> <span>{{$tableData->website}}</span></li>
                                    </ul>
                                </td>
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="{{route('edit-company', $tableData->id)}}"><i
                                                    class="mdi mdi-pencil mr-2 text-muted font-18 vertical-middle"></i>Edit</a>
                                            <a class="dropdown-item" href="{{route('delete-company', $tableData->id) }}"><i
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="printGST_bill.html" class="btn btn-primary waves-effect waves-light">Prinddedet
