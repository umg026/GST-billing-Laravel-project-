                                ...
                                <div class="row mt-0">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control border-bottom" placeholder="CGST Rate"
                                            id="cgst" oninput="calculateNetAmount()">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control border-bottom" placeholder="SGST Rate"
                                            id="sgst" oninput="calculateNetAmount()">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control border-bottom" placeholder="IGST Rate"
                                            id="igst" oninput="calculateNetAmount()">
                                    ...
                                    <div class="col-md-3">
                                        <ul style="list-style: none;float: right;">
                                            ...
                                            <li>
                                                ...
                                                <input type="hidden" value="0" name="text_amount" id="taxAmount">
                                            </li>
                                            <li>
