            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('create-gstbill') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 border p-2">
                                    <input class="form-control" required name="item_description"
                                        placeholder="Enter description" />
                                </div>
                                <div class="col-md-3 border p-2">
                                    <input class="form-control" required type="text" name="total_amount"
                                        id="totalAmountInput" placeholder="Enter INR amount"
                                        oninput="calculateNetAmount()">
                                </div>
                                <div class="col-md-3 border p-2">
                                    <input class="form-control" type="text" name="total_amount_usd"
                            ...
                            <div class="row mt-0">
                                <div class="col-md-3">
                                    <label>CGST (%)</label>
                                    <input type="text" class="form-control border-bottom" placeholder="CGST Rate"
                                ...
                                <div class="col-md-3">
                                    <label>SGST (%)</label>
                                    <input type="text" class="form-control border-bottom" placeholder="SGST Rate"
                                ...
                                <div class="col-md-3">
                                    <label>IGST (%)</label>
                                    <input type="text" class="form-control border-bottom" placeholder="IGST Rate"
